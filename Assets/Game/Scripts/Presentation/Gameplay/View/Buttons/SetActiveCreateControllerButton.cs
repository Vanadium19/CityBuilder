...
{
    public class SetActiveCreateControllerButton : MonoBehaviour
    {
        [SerializeField] private string[] _buttonNames;
        [SerializeField] private bool _isActive;
        [SerializeField] private UIDocument _document;

        private IPublisher<SetActiveCreateBuildingControllerDTO> _publisher;
        ...
        [Inject]
        public void Construct(IPublisher<SetActiveCreateBuildingControllerDTO> publisher)
        {
        ...
        {
            _publisher.Publish(new SetActiveCreateBuildingControllerDTO(_isActive));
        }
    }
}